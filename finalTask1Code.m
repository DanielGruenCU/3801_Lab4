...
col = 'r-';
fig = [1 2 3 4 5 6]; 
%% Initial State Vector  <> Motor Forces, Trim Conditions
...
% var_0 = [0;0;4;0.0374;0;0;0;5;-0.187;0;0;0]; 
% 
% aeroForces = [0;-var_0(8)^2*nu; -var_0(9)^2*nu];

%% 1.4b

  var_0 = [0;0;4;0;-0.0374; pi/2; 5; 0 ; -0.187;0;0;0]; 

  aeroForces = [-var_0(7)^2*nu;-var_0(8)^2*nu; -var_0(9)^2*nu];
...
vel_dot(3,1) = (aVel(2)*vel(1) - aVel(1)*vel(2)) + (g*c_2*c_1) + (1/m) * z_c + (1/m)*a_f(3);
